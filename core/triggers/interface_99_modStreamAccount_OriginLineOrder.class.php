...
/**
 * 	\file		core/triggers/interface_99_modMyodule_miipsoptometrytrigger.class.php
 * 	\ingroup	miipsoptometry
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modMiipsoptometry_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceOriginLineOrder
{
    ...
    public function __construct($db)
    {
        ...
        $this->picto = 'accesaccount@accesaccount';
    }
